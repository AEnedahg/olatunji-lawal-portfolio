...
function Hero() {
  return (
    <section id="hero" className="mt-30 flex flex-col items-center max-w-[320px] mx-auto lg:max-w-screen lg:mx-auto lg:flex-row-reverse lg:justify-center lg:px-20">
      ...
      <div className="relative px-4">
        ...
        />
        <h1 className="uppercase font-medium text-5xl relative z-20 sm:text-center lg:text-left lg:text-4xl">
